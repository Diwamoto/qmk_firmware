 ...
 * `--------------------------------------------------|           |---------------------------------------------- '
 * |  LCTRL |       |   LCTRL   |  LOWER |    Space      |    \  Enter   | RAISE |      |  RALT |  RGUI  | RCTRL |
 * |       |       |           |        |               |      \        |       |      |       |        |       |
 * `------'       `------------------------------------'       '---------------'      '------------------------'
 */
...
[_LOWER] = LAYOUT(
  ...
  //|--------+--------+--------+--------+--------+----------------|     |------------+------+-------------+--------+--------+--------|
      KC_LCTL,        KC_LALT,              LOWER,         KC_SPC,       KC_ENT,       RAISE,               KC_LEFT, KC_DOWN, KC_RIGHT\
  ///-------------------------------------------------------------'     `--------------------'
),
/* RAISE
 * ,------------------------------------------------.        ,----------------------------------------------.
 ...
 */
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX,                       XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX, KC_LVAI,  XXXXXX,\
  //|--------+--------+--------+--------+--------+----------------|     |------------+------+-------------+--------+--------+--------|
